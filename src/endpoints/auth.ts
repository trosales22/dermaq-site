...
export const updateMyProfile = (payload: UpdateMyProfilePayload) => axios.put('/api/v1/customers/my_profile', payload);

export const registerCustomer = (payload: RegisterCustomerPayload) => axios.post('/api/v1/customers', payload);